        ...
        <div class="containers">
            <div class="box form-box">
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($profileImageName) {
                        $edit_query = mysqli_query($con, "UPDATE users SET Username='$username', Email='$email', date='$date', Phonenumber='$phonenumber', Gender='$gender', Country='$country', ProfileImage='$profileImageName' WHERE Id=$id ") or die("error occurred");
                    } else {
                        $edit_query = mysqli_query($con, "UPDATE users SET Username='$username', Email='$email', date='$date', Phonenumber='$phonenumber', Gender='$gender', Country='$country' WHERE Id=$id ") or die("error occurred");
                    }
