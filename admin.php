...
<body>
    ...
    if (isset($_SESSION['admin'])) {
        ...
        if (mysqli_num_rows($adminDataResult) > 0) {
            ...
            echo "<tr><td style='border: 1px solid black; padding: 8px;'>الرقم التعريفي</td><td style='border: 1px solid black; padding: 8px;'>الاسم واللقب</td><td style='border: 1px solid black; padding: 8px;'>البريد الالكتروني</td><td style='border: 1px solid black; padding: 8px;'>تاريخ الميلاد</td><td style='border: 1px solid black; padding: 8px;'>رقم الهاتف</td><td style='border: 1px solid black; padding: 8px;'>الجنس</td><td style='border: 1px solid black; padding: 8px;'>البلد</td><td style='border: 1px solid black; padding: 8px;'>تعديل</td><td style='border: 1px solid black; padding: 8px;'>حذف</td></tr>";
        ...
        function editRow(button) {
            ...
            showStickyBox("هل تريد حفظ التغييرات؟", false, "نعم", "لا", function(confirmSave) {
                if (confirmSave) {
                    ...
                    xhr.send("id=" + id + "&username=" + username + "&email=" + email + "&date=" + date + "&phoneNumber=" + phoneNumber + "&gender=" + gender + "&country=" + country);
                }
            });
        }
