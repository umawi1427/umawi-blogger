                    ...
                    if ($profileImage['error'] === 0) {
                        ...
                        if (in_array($profileImage['type'], $allowedImageTypes) && $profileImageSize <= $maxImageSize) {
                            ...
                            if (move_uploaded_file($profileImageTmpName, $uploadPath)) {
                                $insertQuery = "INSERT INTO users (Username, Email, Date, Password, Phonenumber, Gender, Country, ProfileImage) VALUES ('$username', '$email', '$date', '$password', '$phonenumber', '$gender', '$country', '$profileImageName')";
